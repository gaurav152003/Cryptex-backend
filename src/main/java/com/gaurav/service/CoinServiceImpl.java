...
import com.gaurav.repository.CoinRepository;
    ...
    public List<Coin> getCoins() throws Exception {
        String url =
                "https://api.coingecko.com/api/v3/coins/markets" +
                        "?vs_currency=usd" +
                        "&per_page=250"; // you can set 20 / 50 / 100 / 250
        ...
        try {
            ...
            // ✅ GET request must NOT have a body
            ...
            e.printStackTrace();
            throw new Exception("Unable to fetch coins. Please try again later.");
        }
    }
